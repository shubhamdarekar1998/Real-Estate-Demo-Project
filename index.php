					...
					<div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>we strive to provide exceptional real estate services and information regarding property for sale and rent in and around Every property we represent is carefully selected and vetted making sure we present only the properties you will be interested in. We believe service is key and we always go one step further because we are not only passionate about property, but also passionate about our customers.</p>
                            </div>
                        </div> 
                    </div>
					</center>
					...
					<div class="col-lg-12">
						<div class="content-sidebar p-4">
							<div class="mb-3 col-lg-12">
								<h4 class="double-down-line-left text-secondary position-relative pb-4 mb-4">Happy Customer</h4>
